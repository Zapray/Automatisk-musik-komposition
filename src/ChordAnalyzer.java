...
public class ChordAnalyzer {
	...
	public static void main(String[] args) throws Exception{
		...
		//InputStream is = new BufferedInputStream(new FileInputStream( new File("/Users/KarinBrotjefors/Dropbox/Chalmers/Kandidatarbete/Hooktheory_data/Chorus/Hooktheory-2015-02-18-03-51-40.mid")));//Snabb l�t, kompilerar ej , n�t fel p� slutet...
